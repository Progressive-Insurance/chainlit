...
declare const audioConnectionState: recoil.RecoilState<
  'connecting' | 'on' | 'off'
>;
...
): swr__internal.SWRResponse<
  T,
  Error,
  | Partial<
      swr__internal.PublicConfiguration<T, Error, swr__internal.BareFetcher<T>>
    >
  | undefined
>;
...
declare const updateMessageContentById: (
  messages: IStep[],
